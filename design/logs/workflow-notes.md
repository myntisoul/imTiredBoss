...
### Вывод
- Какой подход лучше сработал для моего проекта: canny
- Что можно использовать для скрингена: `08-canny-scene-01`
- Что нужно доработать позже: топор виктора выглядит странно, вместо автомата несс рядом с ней лежит дубинка? накинуть больше ps1 эстетики
