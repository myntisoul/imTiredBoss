...
| 08-canny-scene-01.png | Canny | `canny1.png`    | более менее сработали позы, | топор виктора выглядит странно, вместо автомата несс рядом с ней лежит дубинка           | selected |
